            ...
            <div class="column is-4-desktop is-6-tablet is-6-tablet" :class="task.status"> 
                ...
                <div class="card"  >
                    ...
                    <header class="card-header ">
                        <!-- Titulo -->
                        <div class="card-title card-header-title" contenteditable @blur="updateContent($event, 'title', task)">{{props.task.title}}</div>
                        <!-- Botones -->
                            <!--Para fichas activas-->
                    ...
                    <div class="card-content">
                        <div class="content">
                            <div class="todo-description" contenteditable @blur="updateContent($event, 'description', task)">{{props.task.description}} </div>
                        </div>
                    </div>
                    <!-- Footer -->
                    <div class="task-footer is-flex is-align-items-end is-justify-content-end">
                        <time class=" is-family-monospace is-fullwidth pr-2" :datetime="moment(String(task.created_at)).format('YYYY/DD/MM')">{{moment(String(props.task.created_at)).format('hh:mm A - DD/MM/YYYY')}} </time>
                    </div>
                </div>
                <!---->
            </div>
