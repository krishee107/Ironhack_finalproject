...
<script setup>
    ...
    /*Cargamos las tareas si no existen */
    onMounted(async () =>{
    ...
    /* Actualizar los datos de una tarea y añadirlo al historial */
    ...
    /* Cambiar el estado de una tarea activa/completada*/
    const cambiarEstadoTarea = async(task) =>{
        /* Pasar una tarea de activa ---> completada*/
        if(task.status == "completada")
            task.status = "activa"
        /* Pasar de completada ---> activa */
